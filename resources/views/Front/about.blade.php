		...
		<div class="container">
			<div class="row no-gutters	 my-5">
				...
				<div class="col-lg-10 p-3" style="background:#F7C70E;">
					...
					<p>VELARA HOTEL offers exclusive services and benefits for the comfort of its guests. The hotel's family-friendly and home-like accommodation concept also provide many advantages such as a supermarket, a pharmacy, a tobacco shop, a hair dresser and many more within a walking distance.</p></div>
			</div>
				<div class="row no-gutters my-5">
				<div class="col-lg-10 p-3" style="background:#F7C70E;">
					<h3>BREAKFAST SERVICE</h3>
					<p>The hotel restaurant with both indoor and outdoor seating offers an open-buffet breakfast and is directly accessible from guestroom corridors.</p></div>
				<div class="col-lg-2"><div class="media block-6 services active py-5 d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex align-items-center justify-content-center">
							<!-- <span class="ion-ios-car"></span> -->
				...
				<div class="col-lg-10 p-3" style="background:#F7C70E;">
					<h3>BUSINESS </h3>
					<p>VELARA HOTEL provides significant services for a flawless business-travel experience. The hotel's business centre is designated to meet all your business travel needs and available to assist you with all office services such as scanning and emailing documents, fax services, photocopying, printing and offices supplies.</p></div>
			</div>
			<div class="row no-gutters my-5">
				<div class="col-lg-10 p-3" style="background:#F7C70E;">
					<h3>Suites & SPA</h3>
					<p>Spa at VELARA HOTEL is your spa, so enjoy it your way. Whether you wish to visit us in order to indulge in our luxury treatments, visit our Thermal Suite for a heat and ice journey like no other, rejuvenate with mud treatments in the double Rasul Chamber you will relax and enjoy the whole gratifying luxurious experience.</p></div>
				<div class="col-lg-2"><div class="media block-6 services active py-5 d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex align-items-center justify-content-center">
							<!-- <span class="ion-ios-car"></span> -->
